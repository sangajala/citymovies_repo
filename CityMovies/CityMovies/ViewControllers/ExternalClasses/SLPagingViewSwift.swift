...
public class SLPagingViewSwift: UIViewController, UIScrollViewDelegate {
    ...
    public var didChangedPage2: SLPagingViewDidChanged?
    ...
    public convenience init(items: [UIView], views: [UIView]) {
        self.init(items: items, views: views, showPageControl:false, navBarBackground:UIColor.init(colorLiteralRed: 39/255.0, green: 49/255.0, blue: 72/255.0, alpha: 1.0))
    }
    
    public convenience init(items: [UIView], views: [UIView], showPageControl: Bool){
        self.init(items: items, views: views, showPageControl:showPageControl, navBarBackground:UIColor.init(colorLiteralRed: 39/255.0, green: 49/255.0, blue: 72/255.0, alpha: 1.0))
    }
    ...
    public init(items: [UIView], views: [UIView], showPageControl: Bool, navBarBackground: UIColor) {
        ...
        navigationBarView.backgroundColor = UIColor.init(colorLiteralRed: 22/255.0, green: 23/255.0, blue: 27/255.0, alpha: 1.0)//navBarBackground
        ...
        for (i, v) in items.enumerate() {
            ...
            v.frame           = CGRectMake(originX, 8+15, vSize.width, vSize.height)
            v.tag             = i
    ...
    public convenience init(controllers: [UIViewController]){
        self.init(controllers: controllers, showPageControl: true, navBarBackground: UIColor.init(colorLiteralRed: 39/255.0, green: 49/255.0, blue: 72/255.0, alpha: 1.0))
    }
    ...
    public convenience init(items: [UIView], controllers: [UIViewController]){
        self.init(items: items, controllers: controllers, showPageControl: true, navBarBackground: UIColor.init(colorLiteralRed: 39/255.0, green: 49/255.0, blue: 72/255.0, alpha: 1.0))
    }
    public convenience init(items: [UIView], controllers: [UIViewController], showPageControl: Bool){
        self.init(items: items, controllers: controllers, showPageControl: showPageControl, navBarBackground: UIColor.init(colorLiteralRed: 39/255.0, green: 49/255.0, blue: 72/255.0, alpha: 1.0))
    }
    ...
    public override func viewWillLayoutSubviews() {
        ...
        self.navigationBarView.frame = CGRectMake(0, -20, self.SCREENSIZE.width, 64)
    }
    ...
    public func setCurrentIndex(index: Int, animated: Bool){
        ...
        self.scrollView.setContentOffset(CGPointMake(320, self.scrollView.contentOffset.y), animated: animated)
    }
    ...
    private func setupPagingProcess() {
        ...
        self.scrollView.backgroundColor                = UIColor.init(colorLiteralRed: 39/255.0, green: 49/255.0, blue: 72/255.0, alpha: 1.0)
    ...
    private func sendNewIndex(scrollView: UIScrollView){
        ...
        self.didChangedPage2?(currentPage: currentIndex)
    }
    ...
    //MARK: - Popout method
    public func popSLPagingViewSwift(){
